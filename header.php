...
<body onload="preloadAnimation()">
	<div id="top"></div>
	<a href="#top"><button id="btn-top" title="Go to top" style="display:none">Top</button></a>

<div id="wrapper" style="display:none;">
	<header>
		<nav id="nav">
			<ul class="inverted-bar">
				<li><a href="#tasha">tasha</a></li>
